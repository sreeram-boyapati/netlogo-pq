...
public class PriorityQueueExtension extends org.nlogo.api.DefaultClassManager
{
	...
	private static final int PQUEUE = Syntax.WildcardType();
	private static final int ANY = Syntax.WildcardType();
	private static final int NUM = Syntax.NumberType();

	public void load(org.nlogo.api.PrimitiveManager m) {
	...
	public org.nlogo.core.ExtensionObject readExtensionObject(
	    org.nlogo.api.ExtensionManager em, String typeName, String value) throws ExtensionException {
	...
	getpq(Argument arg) throws ExtensionException, LogoException
	{
		...
		if(!(obj instanceof PQ))
			error("not a priority queue: "+org.nlogo.api.Dump.logoObject(arg));
		return (PQ)obj;
	}
	...
	PQ implements org.nlogo.core.ExtensionObject
	{
		int n;
		Element a[];
		...
		public String
		dump(boolean readable, boolean exportable, boolean reference)
		{
			...
			for(int i = 0; i < n; i++){
				...
				buf.append(" ");
				buf.append(org.nlogo.api.Dump.logoObject(e.obj, true, true));
				buf.append("]");
			}
			return buf.toString() ;
		}
	...
	PQReporter extends Object implements Reporter
	{
		...
		getSyntax()
		{
			return SyntaxJ.reporterSyntax(args, ret);
		}
		public String
		getAgentClassString()
		{
	...
	PQCommand extends Object implements Command
	{
		...
		getSyntax()
		{
			return SyntaxJ.commandSyntax(args);
		}
		public String
		getAgentClassString()
		{
